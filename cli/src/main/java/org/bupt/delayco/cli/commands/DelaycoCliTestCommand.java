 ...
 */
package org.bupt.delayco.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.bupt.delayco.cli.api.DelaycoCliCommands;
...
public class DelaycoCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DelaycoCliTestCommand.class);
    protected final DelaycoCliCommands service;

    public DelaycoCliTestCommand(final DelaycoCliCommands service) {
